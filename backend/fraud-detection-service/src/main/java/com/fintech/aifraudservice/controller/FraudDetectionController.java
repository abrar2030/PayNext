...
public class FraudDetectionController {
  ...
  @PostMapping("/score")
  public ResponseEntity<Map<String, Object>> getRealTimeFraudScore(
      @Valid @RequestBody TransactionAnalysisRequest request) {
    try {
  ...
  public ResponseEntity<List<TransactionAnalysis>> getHighRiskTransactions(
    ...
    try {
      List<TransactionAnalysis> highRiskTransactions =
          fraudDetectionService.getHighRiskTransactions(limit);
