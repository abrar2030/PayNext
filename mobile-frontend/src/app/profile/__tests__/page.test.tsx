...
describe('Mobile ProfilePage', () => {
  test('renders profile information', () => {
    ...
    expect(screen.getByRole('button', { name: /edit profile/i })).toBeInTheDocument(); // Example
  });
  ...
  test('renders loading state', () => {
    ...
    }), { virtual: true }); // Use virtual: true to re-mock
  ...
  test('renders error state', () => {
    ...
    jest.mock('../../../hooks/useUserProfile', () => ({
      useUserProfile: () => ({ user: null, isLoading: false, error: new Error(errorMessage) }),
    }), { virtual: true });
