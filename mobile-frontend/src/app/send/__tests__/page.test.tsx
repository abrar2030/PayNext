...
jest.mock('../../../services/PaymentService', () => ({
  sendPayment: jest.fn().mockResolvedValue({ success: true, transactionId: 'txn_456' }),
}));

// Example: Mocking QR Scanner component if used
jest.mock('../../../components/QrScanner', () => () => <div data-testid="qr-scanner-mock">QR Scanner</div>);
...
describe('Mobile SendPage', () => {
  test('renders send payment form elements', () => {
    ...
    expect(screen.getByRole('button', { name: /scan qr/i })).toBeInTheDocument(); // Example
