...
import com.paynext.service.BillingService;
import com.paynext.service.EmailService;
...
public class CheckoutController {
  ...
  public String checkout(Model model) {
    ...
    model.addAttribute(
        "shippingCosts", shoppingCartService.getShippingCosts()); // Corrected method name
    return "checkout";
  }
  ...
  public String placeOrder(
    ...
    if (result.hasErrors()) {
      return "checkout"; // Return the view name directly to reload the checkout page
    }
