...
jest.mock('../../Payments/PaymentHistory', () => () => <div data-testid="payment-history-mock">Payment History</div>);
jest.mock('../../Profile/Profile', () => () => <div data-testid="profile-mock">User Profile</div>);
