...
const HelpCenter = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      description:
        "Learn about sending money, payment methods, and transaction limits.",
      articles: 36,
    },
    {
      ...
      description:
        "Understand our security measures and how to keep your account safe.",
      articles: 18,
    },
    {
      title: "Billing & Fees",
      ...
      description:
        "Information about our pricing plans, fees, and billing cycles.",
      articles: 15,
    },
  ];
  ...
  const troubleshootingSteps = [
    ...
    },
    {
      ...
      description:
        "Based on your description, here are some potential solutions.",
      content: (
        <Box sx={{ mt: 2 }}>
              ...
              <Card elevation={2} sx={{ height: "100%", borderRadius: 2 }}>
                <CardContent sx={{ textAlign: "center" }}>
                  ...
                  <Button
                    ...
                    fullWidth
                    onClick={() =>
                      (window.location.href = "mailto:support@paynext.com")
                    }
                  >
                    Email Us
                  </Button>
  ...
  return (
    <Box sx={{ overflow: "hidden" }}>
      ...
      <Container
        maxWidth="lg"
        sx={{ mt: -8, mb: 12, position: "relative", zIndex: 1 }}
      >
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        <Grid container spacing={6}>
          <Grid item xs={12} md={5}>
            ...
            >
              Having an issue? Our step-by-step troubleshooter will help you
