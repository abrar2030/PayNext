...
const Homepage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Bank-level security ensures your money and personal information are always protected."
    },
    {
      icon: <DevicesIcon fontSize="large" />,
      title: "Multi-Platform",
      description: "Access your account from any device, anywhere, anytime with our responsive platform."
    },
    {
      icon: <AccountBalanceIcon fontSize="large" />,
      title: "Financial Management",
      description: "Track your spending, set budgets, and manage your finances all in one place."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "PayNext has revolutionized how I handle business payments. The interface is intuitive and transactions are lightning fast!",
      image: "https://randomuser.me/api/portraits/women/44.jpg"
    },
    {
      name: "Michael Chen",
      role: "Freelance Developer",
      content: "I receive payments from clients worldwide with minimal fees and maximum security. The dashboard makes tracking everything a breeze.",
      image: "https://randomuser.me/api/portraits/men/32.jpg"
    },
    {
      name: "Emily Rodriguez",
      role: "E-commerce Manager",
      content: "The integration capabilities with our online store have streamlined our entire payment process. Customer satisfaction is up 40%!",
    ...
    <Box sx={{ overflow: 'hidden' }}>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          ...
          >
            Our platform combines cutting-edge technology with user-friendly design to provide the best payment experience possible.
          </Typography>
        </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          ...
          >
            Join thousands of satisfied users who trust PayNext for their payment needs
          </Typography>
        </Box>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body2" sx={{ opacity: 0.7, mb: 2 }}>
                The next generation payment solution for individuals and businesses.
              </Typography>
