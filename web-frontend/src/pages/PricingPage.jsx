    ...
    personal: [
      {
        ...
        description:
          "Perfect for individuals who need simple payment solutions",
        features: [
      ...
      },
      {
        ...
        description:
          "For individuals who need advanced features and higher limits",
        features: [
          { text: "Send money to friends", included: true },
          { text: "Receive payments", included: true },
          { text: "Mobile app access", included: true },
      ...
      },
      {
        ...
        description:
          "Share benefits with up to 5 family members with linked accounts",
        features: [
  ...
  const faqs = [
    {
      ...
      answer:
        "PayNext accepts all major credit and debit cards including Visa, Mastercard, American Express, and Discover. We also support bank transfers, PayPal, and various digital wallets depending on your region.",
    },
    {
      question: "How secure are my transactions?",
      answer:
        "All transactions are protected with bank-level encryption and security. We use advanced fraud detection systems and comply with PCI DSS standards to ensure your financial information remains secure at all times.",
    },
    {
      question: "Can I upgrade or downgrade my plan later?",
      answer:
        "Yes, you can upgrade or downgrade your plan at any time. When upgrading, you'll get immediate access to new features and your billing will be prorated for the remainder of your billing cycle. When downgrading, changes will take effect at the start of your next billing cycle.",
    },
    {
      question: "Is there a free trial available?",
      answer:
        "Yes, we offer a 14-day free trial for our Premium and Business plans. No credit card is required to start your trial, and you can cancel at any time before the trial period ends without being charged.",
    },
    {
      question: "What happens if I exceed my transaction limit?",
      answer:
        "If you approach your transaction limit, you'll receive notifications. If you exceed your limit, additional transactions may be temporarily paused until the next billing cycle, or you may be charged additional fees depending on your plan. We recommend upgrading your plan if you regularly approach your limits.",
    },
    {
      question: "How do I cancel my subscription?",
      answer:
        "You can cancel your subscription at any time from your account settings. If you cancel, you'll continue to have access to your paid features until the end of your current billing cycle. We don't offer refunds for partial billing periods.",
    },
  ];
    ...
    <Box sx={{ overflow: "hidden" }}>
      ...
      >
        <Grid container spacing={4} justifyContent="center">
          {pricingPlans[selectedTab === 0 ? "personal" : "business"].map(
            (plan, index) => (
              <Grid
                item
                xs={12}
